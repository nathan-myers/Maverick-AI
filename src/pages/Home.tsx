  ...
  return (
    <main className="container mx-auto px-6 py-20">
      ...
      <div ref={cardContainerRef1} className="grid md:grid-cols-3 gap-8 mt-20">
        {
        [
          { Icon: Zap, title: "Real-time Analysis", description: "Instant content moderation with advanced AI processing for immediate results.", color: "blue" },
          { Icon: Shield, title: "Smart Protection", description: "Advanced algorithms detect and filter inappropriate content automatically.", color: "purple" },
          { Icon: Rocket, title: "Easy Integration", description: "Simple API integration with your existing platforms and workflows.", color: "green" },
        ].map((feature , index) => (
          <motion.div 
      ...
      <section className="mt-20" ref={cardContainerRef2}>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {
            [
              { Icon: FileText, title: "Input Content", description: "Submit text content through our intuitive interface or API for instant analysis.", color: "blue" },
          { Icon: Zap, title: "AI Analysis", description: "Our advanced AI models analyze content for toxicity, spam, and inappropriate material.", color: "purple" },
          { Icon: BarChart2, title: "Detailed Reports", description: "Receive comprehensive reports with confidence scores and specific content flags.", color: "green" },
            ].map((feature , index) =>
            (
              <motion.div 
            variants={cardVariants}
      ...
      {/* Footer Section */}
      <footer className="mt-20 bg-gray-800 py-10">
