        ...
        <main className="container mx-auto px-6 py-20">
            ...
            <div className="max-w-3xl mx-auto text-center mb-16">
                ...
                <p className="text-xl text-gray-300 mb-12">
                    Delivering scalable, AI-powered content moderation solutions to communities across the globe. We are committed to providing real-time, intelligent moderation no matter where you are.
                </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-20">
                {
                    [
                        {imgurl : "https://upload.wikimedia.org/wikipedia/en/a/a4/Flag_of_the_United_States.svg" , title : "North America" , description : "Serving the USA, Canada, and Mexico with top-tier AI solutions, ensuring rapid and effective content moderation across diverse platforms."},
                        {imgurl : "https://upload.wikimedia.org/wikipedia/en/b/ba/Flag_of_Germany.svg" , title : "Europe" , description : "Providing cutting-edge AI-powered content moderation solutions to various European countries, focusing on multilingual capabilities and diverse cultures."},
                        {imgurl : "https://upload.wikimedia.org/wikipedia/en/4/41/Flag_of_India.svg" , title : "Asia" , description : "Expanding our AI-driven moderation to Asia, supporting major markets including India, China, Japan, and Southeast Asia, adapting to local languages and trends."},
                        {imgurl : "https://upload.wikimedia.org/wikipedia/commons/a/af/Flag_of_South_Africa.svg" , title : "Africa" , description : "Empowering African communities with scalable and reliable AI solutions, ensuring online safety and effective content moderation throughout the continent."},
                        {imgurl : "https://upload.wikimedia.org/wikipedia/commons/b/b9/Flag_of_Australia.svg" , title : "Australia" , description : "Bringing state-of-the-art AI solutions to Australia, ensuring safe online spaces and empowering local platforms to moderate content effectively."},
                        {imgurl : "https://upload.wikimedia.org/wikipedia/en/thumb/0/05/Flag_of_Brazil.svg/1280px-Flag_of_Brazil.svg.png" , title : "South America" , description : "Extending our AI-powered moderation services to South America, supporting diverse languages and cultures across the continent."},
                    ].map((feature, index) => (
                        <motion.div 
          ...
          >
                    ...
                    <div className="mb-4">
                        <img 
                            src={feature.imgurl} 
                            alt={feature.title} 
                            className={`h-12 w-${feature.title === "South America" || feature.title === "Australia" ? "16" : "12"} mx-auto`}
                        />
                    </div>
